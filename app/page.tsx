  ...
  return (
    <div className="min-h-screen bg-white text-text-main flex flex-col font-sans">
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <Image src="/cart-logo-without-background.svg" alt="Tudo Aqui Logo" width={50} height={32} className="object-contain" />
            <span className="text-xl  montserrat font-bold italic text-[#0B60B0]">Tudo Aqui</span>
          </Link>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <div className="hidden md:flex gap-4">
              <button className="text-text-main font-bold px-4 py-2 hover:text-primary transition-colors cursor-pointer">Entrar</button>
              <button className="bg-primary text-white font-bold px-6 py-2.5 rounded-full hover:bg-primary/90 transition-all shadow-md hover:shadow-lg active:scale-95 cursor-pointer">Começar agora</button>
            </div>
            <button
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="py-12 md:py-0 md:min-h-[calc(100vh-5rem)] flex items-center bg-gradient-to-br from-[#F0F8FF] to-blue-50/50 px-4 sm:px-6 lg:px-8 overflow-hidden relative">
          ...
          <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-heading font-regular tracking-tighter text-text-main mb-8 leading-[1.1]">
                Compre <br /> de quem tá <span className="font-semibold">perto</span>. <br />
                <span className="text-primary italic"><span className="font-semibold">Tudo Aqui</span> pra você.</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-text-muted mb-8 md:mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                O Tudo Aqui conecta você aos comércios de Aquiraz de forma rápida e direta. Chega de complicação no WhatsApp.
              </p>
        ...
        >
          <div className="max-w-7xl mx-auto w-full">
            <div className="text-center mb-12 md:mb-20">
              <span className="text-primary font-bold uppercase tracking-[0.2em] text-sm mb-4 inline-block">Vantagens</span>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-text-main tracking-tighter">
                Por que usar o Tudo Aqui?
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              <FeatureCard
                ...
                title="Para Você"
                description="Acesso direto aos lojistas. Chega de pedidos esquecidos no WhatsApp e falta de resposta."
                color="bg-primary/5"
              />
              <FeatureCard
        ...
        {/* Plans Section */}
        <section
          className="flex items-center py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-[#F0F8FF] scroll-mt-20"
          id="planos"
        >
          <div className="max-w-7xl mx-auto w-full">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8 items-stretch">
              ...
              <div className="bg-white rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group">
                ...
                <div className="mb-8">
                  <div className="flex items-baseline gap-1">
                    <span className="text-sm font-bold text-text-muted uppercase tracking-wider">R$</span>
                    <span className="text-4xl md:text-5xl font-bold text-text-main tracking-tighter">39,90</span>
              ...
              <div className="bg-primary rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 shadow-2xl shadow-primary/30 text-white flex flex-col transform md:-translate-y-6 relative border-4 border-white overflow-hidden group">
                ...
                <div className="mb-8 relative z-10">
                  <div className="flex items-baseline gap-1">
                    <span className="text-sm font-bold text-white/70 uppercase tracking-wider">R$</span>
                    <span className="text-5xl md:text-6xl font-bold tracking-tighter">79,90</span>
              ...
              <div className="bg-white rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group">
                ...
                <div className="mb-8">
                  <div className="flex items-baseline gap-1">
                    <span className="text-sm font-bold text-text-muted uppercase tracking-wider">R$</span>
                    <span className="text-4xl md:text-5xl font-bold text-text-main tracking-tighter">149,90</span>
                    <span className="text-lg font-bold text-text-muted">/mês</span>
                  </div>
                </div>
        ...
        <section className="flex items-center py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
          <div className="max-w-6xl mx-auto w-full bg-[#ACD6FE] rounded-2xl md:rounded-[3rem] p-6 sm:p-8 md:p-20 flex flex-col md:flex-row items-center justify-between text-white shadow-[0_40px_100px_-20px_rgba(24,23,37,0.4)] relative overflow-hidden">
            ...
            <div className="md:w-1/2 mb-8 md:mb-0 relative z-10 text-center md:text-left">
              <div className="flex flex-col  justify-center items-center gap-5">
                <h2 className="text-3xl sm:text-4xl md:text-6xl font-heading font-bold leading-[1] tracking-tighter ">
                  Estamos crescendo <br className="hidden lg:block" />
                  <span className="text-primary italic">com você.</span>
                </h2>
                <p className="text-white/100 text-base sm:text-lg md:text-xl mb-8 md:mb-12 max-w-lg leading-normal mt-2 font-medium">
              ...
              <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-6">
                <button className="flex items-center justify-center gap-3 bg-white text-text-main px-8 py-4 rounded-2xl hover:bg-gray-100 transition-all shadow-xl active:scale-95 group">
                  ...
                  <div className="text-left">
                    <div className="text-[10px] font-bold uppercase tracking-widest leading-none opacity-60">Disponível no</div>
              ...
              <div className="relative">
                <div className="w-48 h-[400px] sm:w-56 sm:h-[460px] md:w-64 md:h-[520px] bg-gray-800 rounded-[2rem] sm:rounded-[2.5rem] md:rounded-[3rem] p-2 sm:p-3 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] border-[6px] sm:border-[8px] border-gray-900 relative z-20 overflow-hidden transform hover:scale-105 transition-transform duration-700">
                  <div className="w-full h-full bg-white rounded-[1.6rem] sm:rounded-[2rem] md:rounded-[2.2rem] overflow-hidden relative">
                    <div className="bg-primary h-32 w-full flex items-center justify-center p-4">
                      <Image src="/cart-logo-without-background.svg" alt="Tudo Aqui Logo" width={80} height={26} className="object-contain brightness-0 invert" />
                    </div>
                    <div className="p-4">
        ...
        {/* Support Section */}
        <section
          className="flex items-center py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-t from-white to-[#F0F8FF] scroll-mt-20"
          id="apoie"
        >
          <div className="max-w-4xl mx-auto w-full text-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold mb-6 md:mb-8 text-text-main tracking-tighter">Apoie o Projeto</h2>
              <p className="text-xl text-text-muted mb-12 leading-relaxed font-medium">
                O Tudo Aqui é de <span className="text-text-main font-bold">morador para morador</span>.
                Sem taxas absurdas. Qualquer ajuda mantém o app crescendo pra gente!
              </p>
              ...
              <div className="bg-bg-light p-6 md:p-10 rounded-xl md:rounded-[2rem] border-2 border-dashed border-gray-200 inline-block w-full max-w-xl mb-8 md:mb-12 group hover:border-primary/30 transition-colors">
                <p className="text-xs font-bold text-text-muted mb-4 uppercase tracking-[0.2em]">Chave PIX (E-mail)</p>
                <div className="flex flex-col items-center gap-4">
                  <code className="text-lg sm:text-2xl md:text-3xl font-bold text-primary select-all break-all tracking-tighter">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 bg-[#25D366] text-white px-10 py-5 rounded-2xl font-bold text-xl hover:bg-[#20bd5a] transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 active:scale-95"
                >
                  {/* put wpp icon */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 md:gap-10">
            <div className="flex items-center">
              <Image src="/cart-logo-without-background.svg" alt="Tudo Aqui Logo" width={50} height={36} className="object-contain" />
            </div>
            <div className="flex flex-wrap justify-center gap-10 text-sm font-bold text-text-muted uppercase tracking-widest">
          ...
          <div className="mt-16 pt-8 border-t border-gray-50 text-center text-[10px] font-bold text-text-muted/30 uppercase tracking-[0.3em]">
...
function FeatureCard({ icon, title, description, color }: { icon: React.ReactNode, title: string, description: string, color: string }) {
  return (
    <div className={`p-6 md:p-10 rounded-2xl md:rounded-[2.5rem] ${color} transition-all duration-500 hover:shadow-2xl hover:shadow-gray-100 hover:-translate-y-2 group border border-transparent hover:border-white`}>
      ...
      <h3 className="text-xl md:text-2xl font-heading font-bold mb-3 md:mb-4 text-text-main tracking-tight">{title}</h3>
